...
namespace VvvfSimulator.Yaml.MasconControl
{
    public class YamlMasconMidi
    {
        ...
        public static YamlMasconData? Convert(GUI.Mascon.MasconControlMidi.LoadData loadData)
        {
            //MIDIDataを変換
            MidiData midiData;
            try
            ...
            List<NoteEventSimple> converted_Constructs = GetTime_Line(midiData, loadData.track);
        ...
        public static List<NoteEventSimple> GetTime_Line(MidiData midiData,int track_num)
        {
            List<NoteEventSimple> events = new List<NoteEventSimple>();
