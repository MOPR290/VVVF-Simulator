...
namespace VvvfSimulator.GUI.Create.Waveform
{
    ...
    public partial class Top : Page
    {
        ...
        public Top(YamlControlData ycd, int level)
        {
            ...
            Control_Amplitude_FreeRun_On.Navigate(new ControlAmplitude(ycd.Amplitude.FreeRunAmplitude.On, ControlAmplitudeContent.Free_Run_On));
            Control_Amplitude_FreeRun_Off.Navigate(new ControlAmplitude(ycd.Amplitude.FreeRunAmplitude.Off, ControlAmplitudeContent.Free_Run_Off));
