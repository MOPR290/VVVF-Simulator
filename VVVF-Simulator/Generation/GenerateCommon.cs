...
namespace VvvfSimulator.Generation
{
    public class GenerateCommon
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static bool CheckForFreqChange(VvvfValues control,YamlMasconDataCompiled ymdc, YamlMasconData ymd, double add_time)
        {
            return YamlMasconControl.CheckForFreqChange(control, ymdc, ymd, add_time);
        }
