    ...
    public class Generate_Control_Original2
    {
        ...
        public static Bitmap Get_Control_Original2_Image(VVVF_Values Control, Yaml_VVVF_Sound_Data Sound, bool Precise)
        {
            ...
            Task CycleCalcTask = Task.Run(() =>
            {
                ...
                CycleUVW = Generate_Basic.Get_UVW_Cycle(CycleControl, Sound, 0, (Precise ? 120000 : 6000), Precise);
            });
            ...
            {
                voltage = FS.Generate_FS.Get_Fourier_Fast(ref CycleUVW, 1, My_Math.M_PI_6) * 100;
            });
