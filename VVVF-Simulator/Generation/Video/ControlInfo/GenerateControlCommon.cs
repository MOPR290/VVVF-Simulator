...
namespace VvvfSimulator.Generation.Video.ControlInfo
{
    public class GenerateControlCommon
    {
        ...
        /// <returns></returns>
        public static double Get_Voltage_Rate(VvvfValues Control, YamlVvvfSoundData Sound, bool Precise)
        {
            WaveValues[] PWM_Array = GenerateBasic.Get_UVW_Cycle(Control, Sound, MyMath.M_PI_6, 120000, Precise);
            double result = FS.GenerateFourierSeries.Get_Fourier_Fast(ref PWM_Array, 1, 0);
