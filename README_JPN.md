...
## EXEでのセットアップ
[Releases](https://github.com/JOTAN-0655/VVVF-Simulator/releases)に移動し、`VVVF-SIM.zip`をダウンロードしてください。<br>
...
- [サンプルファイル](https://github.com/JOTAN-0655/VVVF-Simulator/releases/download/1.6.0.0/yaml_samples.zip)
